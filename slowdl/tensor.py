...
class Tensor(object):
    def __init__(self, data: Union[List,np.array], parents=None, genesis_op=None, requires_grad=False, id=None):
    ...
    def __add__(self, other):
        if self.requires_grad and other.requires_grad:
            out =  Tensor(self.data + other.data, parents=[self,other], genesis_op="add", requires_grad=True)
    ...
    def __sub__(self, other):
        if self.requires_grad and other.requires_grad:
            return Tensor(self.data - other.data, parents=[self,other], genesis_op="sub", requires_grad=True)
